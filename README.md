# Keycloak service for Kubernetes on Wodby

Run Keycloak as a reusable Kubernetes application service with Wodby.
...
- [Keycloak application stack](https://github.com/wodby/stack-keycloak)
...
| Versions | `26.7` by default |
| Workloads | `main` (Deployment, primary) |
| Containers | `keycloak` using `quay.io/keycloak/keycloak` |
| Endpoints | `keycloak`: HTTP 8080 (main), HTTP 9000 |
...
Use this service through [Keycloak application stack](https://github.com/wodby/stack-keycloak), or reference `keycloak` from a
custom Wodby stack.
